...
function sqrt(){
  ...
  if(listNum.length==cont){
    ...
    document.getElementById('dados').innerHTML="√" +stringList1 + " = "
    var result=Math.sqrt(stringList1);
    document.getElementById('dados').innerHTML=result;
  }
}
function exp(){
  var cont=0;
  ...
  if(listNum.length==cont){
    listNum1=listNum;
    listNum=[];
    document.getElementById('dados').innerHTML=operacaoMatematica;
  }
}
function mais(){
  var cont=0;
...
function ponto(){
  ...
  if(listNum.length==contPonto){
    listNum.push('.');
    publicar=listNum.join('');
    document.getElementById('dados').innerHTML=publicar;
  }
}
function insertUm(){
