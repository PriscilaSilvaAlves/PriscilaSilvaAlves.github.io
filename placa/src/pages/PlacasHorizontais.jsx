      ...
      <header className="App-header">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <span className='info'>(Para as placas de Aproveite só é 
            obrigatógio colocar Título, Preço Real, Preço Centavos e Tipo.Para as placas de Oferta 
          ...
          <label>
            <span>Preço Promocional Reais: </span>
            <input
              type="text"
              name="precoReal1"
              value={precoReal1}
            ...
            <label>
                <span>Preço Promocional Centavos: </span>
                <input
                type="text"
                name="precoCentavos1"
