  ...
  return (
    <div ref={ref} className="placa-ofertaDupla">
        ...
        <div className="corpoOfertaDupla">
            ...
            {(precoInicial && precoInicial !== "-") && <span className='cifraoCashMaisDupla'>&nbsp;&nbsp;&nbsp;De R$&nbsp;{precoInicial}. Por R$&nbsp;&nbsp;&nbsp;</span>}
        ...
        <div className="corpoOfertaDupla">
          <div
            ...
            {(precoInicial2 && precoInicial2 !== "-") && <span className='cifraoCashMaisDupla'>&nbsp;&nbsp;&nbsp;De R$&nbsp;{precoInicial2}. Por R$&nbsp;&nbsp;&nbsp;</span>}
            <div className='precoOfertaDupla'>
