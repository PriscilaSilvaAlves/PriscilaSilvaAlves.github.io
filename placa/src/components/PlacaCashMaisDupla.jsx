...
const PlacaOfertaDupla = forwardRef(({ titulo, precoInicial, precoReal, precoCentavos, dataInicial, dataFinal,
  ...
  return (
    <div ref={ref} className="placa-ofertaDupla">
        <span className="sloganCashMaisDupla">CASH MAIS</span>
        <div className="corpoOfertaDupla">
            ...
            {(precoInicial && precoInicial !== "-") && <span className='cifraoCashMaisDupla'>&nbsp;&nbsp;&nbsp;De &nbsp;<b>{precoInicial}</b>. Por:</span>}
        ...
        <div className="corpoOfertaDupla">
          <div
            ...
            {(precoInicial2 && precoInicial2 !== "-") && <span className='cifraoCashMaisDupla'>&nbsp;&nbsp;&nbsp;De &nbsp;<b> {precoInicial2} </b>. Por:</span>}
            <div className='precoOfertaDupla'>
