...
import './PlacaOfertaExtra.css';

const PlacaOfertaExtra = forwardRef(({ titulo, precoInicial, precoReal, precoCentavos, dataInicial, dataFinal }, ref) => {
  ...
  return (
    <div ref={ref} className="placa-oferta">
        <span className="sloganOfertaExtra">OFERTA EXTRA</span>
        <div className="corpoOferta">
          ...
          >
            ...
            {(precoInicial && precoInicial !== "-") && <span className='cifraoOferta'>&nbsp;De&nbsp;<b>{precoInicial} </b>. Por R$</span>}
...
export default PlacaOfertaExtra; 