...
const PlacaOferta = forwardRef(({ titulo, precoInicial, precoReal, precoCentavos, dataInicial, dataFinal }, ref) => {
  ...
  return (
    <div ref={ref} className="placa-oferta">
        <span className="sloganDiaD">DIA D+</span>
        <div className="corpoOferta">
          ...
          >
            ...
            {(precoInicial && precoInicial !== "-") && <span className='cifraoDiaD'>&nbsp;De R$&nbsp;<b>{precoInicial} </b>. Por R$</span>}
            {!precoInicial && <span className='cifraoDiaD'>&nbsp; R$</span>}
            <div className='precoDiaD'>
              <span 
