...
import './PlacaOfertaExtraDupla.css';
...
const PlacaOfertaDupla = forwardRef(({ titulo, precoInicial, precoReal, precoCentavos, dataInicial, dataFinal,
  ...
  return (
    <div ref={ref} className="placa-ofertaDupla">
        <span className="sloganOfertaExtraDupla">OFERTA EXTRA</span>
        <div className="corpoOfertaDupla">
            ...
            {(precoInicial && precoInicial !== "-") && <span className='cifraoOfertaDupla'>&nbsp;De R$&nbsp;<b>{precoInicial}</b>. Por:</span>}
        ...
        <div className="corpoOfertaDupla">
          <div
            ...
            {(precoInicial2 && precoInicial2 !== "-") && <span className='cifraoOfertaDupla'>&nbsp;De R$&nbsp;<b> {precoInicial2} </b>. Por:</span>}
            <div className='precoOfertaDupla'>
