...
const PlacaOferta = forwardRef(({ titulo, precoInicial, precoReal, precoCentavos, dataInicial, dataFinal }, ref) => {
  ...
  return (
    <div ref={ref} className="placa-oferta">
        <span className="sloganCashMais">CASH MAIS</span>
        <div className="corpoOferta">
          ...
          >
            ...
            {(precoInicial && precoInicial !== "-") && <span className='cifraoCashMais'>&nbsp;&nbsp;&nbsp;De R$&nbsp;{precoInicial}. Por R$&nbsp;&nbsp;&nbsp;</span>}
            {!precoInicial && <span className='cifraoCashMais'>&nbsp; R$</span>}
            <div className='precoOferta'>
              ...
              <span className="precoCashCentavos">,{precoCentavos}</span>
            </div>    
        </div>
